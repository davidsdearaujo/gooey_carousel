...
class GooeyCarouselState extends State<GooeyCarousel>
  ...
  double?
      _dragDirection; // +1 when dragging left to right, -1 for right to left

  late bool _dragCompleted; // has the drag successfully resulted in a swipe
